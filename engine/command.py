...
def allCommands(message=1):
    ...
    try:
        ...
        # Weather Forecast
        elif "weather" in query or "forecast" in query or "temperature" in query or "climate" in query or "weather report" in query:
...
#                 # ----- dlt these part later ------
#                 # time.sleep(2)
#                 # pyautogui.hotkey('alt', 'f4')
                
#                 # if 'video call' in query or 'phone call' in query:
#                 #     pyautogui.hotkey('alt', 'f4')
...
#             today_date = format_date()
#             # speak(f'Today is {day}, {today_date}')
#             speak(f'Today is {day}, {today_date}, The time is {time_now}')
#             print(f'Today is {day}, {today_date}')
...
#             speak("Wait a few seconds sir, calculating your internet speed..")
#             download_speed, upload_speed = get_internet_speed()
#             speak(f"Sir, we hve {download_speed} Megabits per second downloading speed and {upload_speed} Megabits per second uploding speed")
#             print(f"Download Speed: {download_speed} Mbps")
#             print(f"Upload Speed: {upload_speed} Mbps")
