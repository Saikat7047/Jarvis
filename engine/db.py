...
# query = "INSERT INTO sys_command VALUES (null,'ms word', 'C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Word 2016.exe')" # word 2016 typo probably spacing
# cursor.execute("INSERT INTO sys_command VALUES (null,'Excel', 'C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Excel.exe')")
...
# # del_entry = "DELETE FROM web_command WHERE name = 'bard'"
# # # Execute the SQL command
# # cursor.execute(del_entry)
# cursor.execute('DROP TABLE sys_command')
# cursor.execute('DROP TABLE web_command')
# con.commit()
